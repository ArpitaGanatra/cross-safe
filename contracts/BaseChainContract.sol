...
contract CallContract is AxelarExecutable {
    ...
    event addFundsEvent(address a1,uint256 _safeId,uint256 _funds);
...
//send notification about widthraw request
        ...
        if (
            ...
            require(
                ...
                "The amount is greater than Safe Balance"
                    ...
                    (bool success1, ) = _addr.call{value: safeOwner[_safeId].balance}("");
    ...
    function addFunds(uint256 _safeId)public payable{
        require(safeOwner[_safeId].a1 == msg.sender || safeOwner[_safeId].a2 == msg.sender  ,"You are not a owner of this safe");
        safeOwner[safeId].balance += msg.value; 
        emit addFundsEvent(msg.sender,_safeId,msg.value);
    }
